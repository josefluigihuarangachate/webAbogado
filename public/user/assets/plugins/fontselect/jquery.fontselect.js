				...
				fontsAsHtml: function() {
					...
					for (i = 0; i < systemFonts.length; i++){
						...
						if ((localFonts.length > 0 || googleFonts.length > 0) && i == systemFonts.length-1) {
							style += ';border-bottom:1px solid #eee'; // Separator after last system font
						}
