...
// Header Font Family 
function headerFontFamily(font) {
	...
	$('.page-header, .page-header h1, .page-header h2, .page-header h3, .page-header h4, .page-header h5, .page-header h6,  .page-header p, .page-header .text-truncate').css({
		fontFamily: "'" + fontFamily + "'",
		fontWeight: fontWeight
	});
}

$('#headerFontFamily').fontselect({
		placeholder: 'Pick a font from the list',
		searchable: true
	})

	.on('change', function () {
		headerFontFamily(this.value);
	});

// Sidebar Font Family
function sidebarFontFamily(font) {
	console.log('You selected font: ' + font);
	...
	// Set selected font on paragraphs
	$('.page-sidebar, .page-sidebar p, .page-sidebar small').css({
		fontFamily: "'" + fontFamily + "'",
		fontWeight: fontWeight
	});
}

$('#sidebarFontFamily').fontselect({
		placeholder: 'Pick a font from the list',
		searchable: true
	})

	.on('change', function () {
		sidebarFontFamily(this.value);
	});

// Container Font Family
function contentFontFamily(font) {
	console.log('You selected font: ' + font);
	...
	// Set selected font on paragraphs
	$('.page-content,  .page-content div,  .page-content p, .page-content small, page-content .modal, page-content .add-sidebar, page-content .daterangepicker').css({
		fontFamily: "'" + fontFamily + "'",
		fontWeight: fontWeight
	});
}

$('#contentFontFamily').fontselect({
		placeholder: 'Pick a font from the list',
		searchable: true
	})

	.on('change', function () {
		contentFontFamily(this.value);
	});
...
function headingFontFamily(font) {
	...
	// Set selected font on paragraphs
	$('h1, h2, h3, h4, h5, h6, .page-container .card-hearer').css({
		fontFamily: "'" + fontFamily + "'",
		fontWeight: fontWeight
	});
}

$('#headingFontFamily').fontselect({
		placeholder: 'Pick a font from the list',
		searchable: true
	})

	.on('change', function () {
		headingFontFamily(this.value);
	});

// Footer Font Family 
function footerFontFamily(font) {
	console.log('You selected font: ' + font);
	...
	// Set selected font on paragraphs
	$('.page-footer, .page-footer a').css({
		fontFamily: "'" + fontFamily + "'",
		fontWeight: fontWeight
	});
}

$('#footerFontFamily').fontselect({
		placeholder: 'Pick a font from the list',
		searchable: true
	})

	.on('change', function () {
		footerFontFamily(this.value);
	});
