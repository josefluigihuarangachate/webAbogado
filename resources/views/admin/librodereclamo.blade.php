...
<html>
    ...
    <body>
                            ...
                            <div class="card mg-b-20">
                                <div class="d-block d-md-flex justify-content-between align-items-center pd-15 bd-b">
                                    <h2 class="tx-13 tx-medium mb-0 tx-dark">
                                        Area del Cliente
                                        <br>
                                        <small>*Area del cliente: Sirve para ver los reclamos, quejas o sugerencias de los clientes.</small>
                                    </h2>
                                            ...
                                            <div class="col-12 col-md-12 bd pd-15">
                                                <div class="tab-pane fade active show" id="latestProducts" role="tabpanel" aria-labelledby="latestProducts">
                                                    <div class="card-body"  id="productScrollBar">
                                                        ...
                                                        <br>
                                                        <div class="row clearfix" style="overflow-x:auto;height: calc(100vh - 200px) !important;" id="listado_reclamo" name="listado_reclamo">
                                                            <!-- PONER CODIGO AQUI --> 
                                                        </div>
                                                    </div>       
                                                </div>
        ...
        <script src="admin/assets/js/crud/crud_areacliente.js<?php echo $v; ?>"></script>
