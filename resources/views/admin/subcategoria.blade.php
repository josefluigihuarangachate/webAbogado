...
<html>
    ...
    <body>
                            ...
                            <div class="card mg-b-20">
                                <div class="d-block d-md-flex justify-content-between align-items-center pd-15 bd-b">
                                    <h2 class="tx-13 tx-medium mb-0 tx-dark">
                                        Listado Sub Categoria
                                        <br>
                                        <small>* Las Sub categorias podran ser eliminados si no estan relacionado con una categoria.</small>
                                    </h2>
                    ...
                    <form method="POST" action="#" enctype="multipart/form-data" id="EformData" name="EformData">
                        ...
                        <div class="modal-body" style="/* height: calc(100vh - 200px);overflow: auto; */">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Ecodigo" name="Ecodigo" placeholder="*Codigo">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="Edescripcion" name="Edescripcion" placeholder="*Descripcion" style="resize: none;" rows="5"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="Ecategoria">Categoria</label><br>
        ...
        <script src="admin/assets/js/crud/crud_subcategoria.js<?php echo $v; ?>"></script>
    </body>
</html>