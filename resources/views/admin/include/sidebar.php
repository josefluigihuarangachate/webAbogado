            ...
            <ul class="accordion-menu">
                ...
                <li>
                    <a href="">
                        ...
                        <span>Estadísticas</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                ...
                <li>
                    <a href="">
                        ...
                        <span>Blog</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="./listaPost">Lista de Blogs</a></li>
                        <li><a href="./nuevoPost">Registrar Blog</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="./listaSuscripcion">Lista de Suscripciones</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                        ...
                        <span>Area de Cliente</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="./listaLibroReclamo">Lista de Area de Cliente</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                ...
                <li>
                    <a href="">
                        ...
                        <span>Tipo de Usuario</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="./listaTypeUser">Lista Tipo de Usuarios</a></li>
                        <li><a href="./nuevoTypeUser">Nuevo Tipo de Usuario</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                ...
                <li>
                    <a href="">
                        ...
                        <span>Administradores</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="./listaAdministrador">Lista de Administradores</a></li>
                        <li><a href="./nuevoAdministrador">Nuevo de Administrador</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                        ...
                        <span>Abogados</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="./listaAbogado">Lista de Abogados</a></li>
                        <li><a href="./nuevoAbogado">Nuevo de Abogado</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                        ...
                        <span>Clientes</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="./listaCliente">Lista de Clientes</a></li>
                        <li><a href="./nuevoCliente">Nuevo de Cliente</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                    ...
                    <ul class="sub-menu">
                        <li><a href="./listaOtroUsuario">Lista de Otros Usuarios</a></li>
                        <li><a href="./nuevoOtroUsuario">Nuevo Usuario</a></li>
                    </ul>
                </li>
