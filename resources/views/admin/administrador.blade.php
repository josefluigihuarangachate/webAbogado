                            ...
                            <div class="card mg-b-20">
                                <div class="d-block d-md-flex justify-content-between align-items-center pd-15 bd-b">
                                    <h2 class="tx-13 tx-medium mb-0 tx-dark">
                                        ...
                                        <br>
                                        <small>* Los administradores podran ser eliminados si no estan relacionados con otros datos. Tambien son usuarios encargados de administrar el sistema.</small>
                                    </h2>
