                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="generic_content clearfix">
                                                        ...
                                                        <div class="generic_feature_list">
                                                            <ul>
                                                                <li><span>1</span> Hora de chat</li>
                                                                <li><span>1</span> Mes de suscripcion</li>
                                                                <li><span>24/7</span> Ayuda</li>
                                                            </ul>
                                                        </div>
                                                        <!--//FEATURE LIST END-->
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="generic_content active clearfix">
                                                        ...
                                                        <div class="generic_feature_list">
                                                            <ul>
                                                                <li><span>9</span> Horas de chat</li>
                                                                <li><span>3</span> Meses de suscripcion</li>
                                                                <li><span>24/7</span> Ayuda</li>
                                                            </ul>
                                                        </div>
                                                        <!--//FEATURE LIST END-->
